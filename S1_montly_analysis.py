# -*- coding: utf-8 -*-
"""
Created on Mon Nov 19 14:53:27 2018
...
for month in range(1,13):
    ...
    for shp in shapefiles:
        ...
        #save to array
        output.append([month,index,mean_VH,std_VH,mean_VV,std_VV,VH_VV,d_VH_VV])
        output.sort(key=lambda x: x[0])
        
    #export to csv    
    with open(dirpath + '/outputs/site1/radar/S1/2016/'+str(month)+'_stats.csv', "w") as myfile:
        writer = csv.writer(myfile, lineterminator='\n')
        writer.writerow(('Month','Plot','VH','d_VH','VV','d_VV','VH/VV','dVH/VV'))
